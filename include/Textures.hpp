    ...
    class Textures {
      ...
      private:
        ...
        int createTextureImage(const std::string& filename, VkQueue graphicsQueue, VkCommandPool commandPool) {
            ...
            ce::BufferObject imageStagingBuffer(this->physical, this->logical);
            ...
            // Copy image data
            copyImageBuffer(this->logical, graphicsQueue, commandPool, imageStagingBuffer.getBuffer(), texImageObj->getImage(), width,
                            height);
